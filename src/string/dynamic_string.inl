namespace fsds
{
	...
	constexpr const DynamicString* DynamicStringItterator::str() const
	{
		return this->m_str;
	}
	constexpr size_t DynamicStringItterator::currentPosition() const
	{
		return this->m_pos;
	}
	constexpr size_t DynamicStringItterator::currentCodePointOffset() const
	{
